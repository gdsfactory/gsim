...
# )
sim.set_eigenmode(num_modes=1, target=7e9, tolerance=1e-6)

xsxxs

# %%
sim.set_output_dir("./sim_qpdk_resonator_eigenmode")
...
# print(data["Boundaries"]["Absorbing"])
...
df = pd.read_csv(results["eig.csv"])
