    ...
    def plot_3d(
        ...
        *,
        ...
        Args:
            ...
            include_internal_groups: Include autogenerated interfaces and mesh
                helpers in the controls. They remain hidden initially.
            color_palette: Ordered physical-group colors. Defaults to the
                unique generic-PDK layer colors in layer-view order.
            group_opacity: Uniform physical-group opacity from 0 to 1. Set to
                ``None`` to restore the shared viewer's legacy opacity rules.
        ...
        resolved_color_palette = (
            generic_pdk_color_palette() if color_palette is None else color_palette
        )
