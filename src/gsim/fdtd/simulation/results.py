"""Results extraction and processing for Tidy3D simulations.

This module provides utilities for retrieving and caching simulation results.
"""
...
def get_sim_hash(sim: td.Simulation) -> str:
    ...
    Returns:
        MD5 hash string of the simulation.
    """
...
def _get_results(
    ...
    Returns:
        SimulationData object with results.
    """
...
def get_results(
    ...
    Returns:
        Future that resolves to SimulationData.

    Example:
        ```python
        from gsim.fdtd import get_results

        sim_data = get_results(sim)  # threaded
...
def get_results_batch(
    ...
    """Return BatchData from a list of Simulations.

    Args:
        sims: list of tidy3d Simulations.
        dirpath: to store results locally.
        verbose: prints info messages and progressbars.

    Returns:
        BatchData with all simulation results.
    """
