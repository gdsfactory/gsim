"""Generic GMSH utility functions for mesh generation.

Provides low-level helpers for creating geometry, fragmenting,
assigning physical groups, and setting up mesh refinement in GMSH.
These are solver-agnostic — no Palace or Meep imports.
"""
